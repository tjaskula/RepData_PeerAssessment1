...
![Steps By Day](plots/StepsByDay.png)
...
![Average Number of Steps per interval](plots/averageNumSteps.png)
...
![Steps by Day without NAs](plots/StepsByDayNoNas.png)
...
![Steps by interval and day type](plots/StepsByIntervalAndDayType.png)